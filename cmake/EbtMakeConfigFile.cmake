...
set(EBT_CONFIG_TEMPLATE_PATH ${CMAKE_CURRENT_LIST_DIR})

function(EbtMakeConfigFile PACKAGE_NAME)
	...
	configure_file(${EBT_CONFIG_TEMPLATE_PATH}/Config.cmake.in "${PROJECT_BINARY_DIR}/${PACKAGE_NAME}Config.cmake" @ONLY)
